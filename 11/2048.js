...
var sSize=Math.min(innerWidth,innerHeight);
var rate=sSize<500?sSize/500:1;
var SIZE=500*rate, BG="#BBADA0", RADIUS=10*rate,
    cv=$("#cv"), pen=cv.getContext("2d"),
    OFFSET=20*rate, CSIZE=100*rate, CRADIUS=6*rate, GRIDBG="#ccc0b3",
    CELLBGS={
        "2":"#eee4da",
        "4": "#ede0c8",
        "8": "#f2b179",
